window.Win10 = {
    ...
    _init:function () {
        ...
        $("#win10-btn-browser").click(function () {
            ...
            // var offset = ['0', '0'];
            layer.prompt({
                title: Win10.lang('Safari','Visit URL'),
                formType: 2,
                value: 'www.',
                skin:'win10-layer-open-browser',
                area: ['300px', '150px'],
                ...
                layer.close(i);
                layer.msg(Win10.lang('正在加载,请稍候...','Hold on please...'),{time:1500},function () {
        ...
        document.body.onbeforeunload = function(){
            window.event.returnValue = Win10.lang( 'Mac系统可能不会保存您所做的更改','Your Mac OS system may not save your changes.');
        };
        ...
        //打广告
        setTimeout(function () {
            console.log(Win10.lang('Mac OS系统维护时间05:00至24:00\n更多信息请详情：https://mac-system.github.io \n'))
        },2000);
        //点击清空右键菜单
        ...
        Win10.setContextMenu('#win10>.desktop',[
            ['<i class="fa fa-fw fa-star"></i> 收藏本页',function () {
                ...
                if (ua.indexOf("360se") > -1) {
                    layer.alert(Win10.lang('您的APP不支持,请按 Ctrl+D 手动收藏!','Your browser does not support, please press Ctrl+D to manual collection!'));
                }
    ...
    aboutUs: function() {
        ...
        layer.open({
            ...
            anim: 2,
            skin: 'win10-open-iframe',
            title: 'Mac-System '+this._version,
            shadeClose: true, //开启遮罩关闭
            area: ['320px', '200px'], //宽高
            content: '<div style="padding: 10px;font-size: 12px">' +
			'<p>开发者：木子的忧伤、尤里2号©版权所有</p>' +
            '<p>维护者：IT Geek JEEP-711©版权所有</p>' +
			'<p>Beat_Version：1.1.2.3</p>' +
            '</div>'
        });
    },
...
//设置壁纸
Win10.setBgUrl({
 main:'include/photo/wallpapers/main.jpg',
 mobile:'include/photo/wallpapers/mobile.jpg',
});
...
Win10.setAnimated([
  'animated flip',
   'animated bounceIn',
    ...
    setTimeout(function () {
    Win10.newMsg('Mac-System', 'Mac OS系统维护时间05:00至24:00',function () {
